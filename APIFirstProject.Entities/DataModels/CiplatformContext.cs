...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA414199B753E3");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C340A5C6D92");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52AC65A40A");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E795768786933680");
        ...
        {
            entity.HasKey(e => e.ContactusId).HasName("PK__contactu__226C4679C96ABF85");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favourit__94E4D8CA7090EE3F");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7BFE0C90C");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB2411C9BEE");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838A81AEE1A7");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC822101F0E");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED158BE781AE2");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E8EA46101A");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E5172B0DAA8AA");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___82712008DF7F9F80");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5ACEE79AD7C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__password__3213E83F8A6E76AD");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA8379C3E09709");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C568D64FC6A");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__04497867C5AB5B2A");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C0EF2410D");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF50683FFBC6CE");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370F3B0F403D");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576BCDE52DFA");
